...
class CommentCreate(APITestCase):
    ...
    def test_jwt_authentication(self):
        response = self.client.post(self.login_url, data={"username": "selcuk1234", "password": "sifre1234"})
...
class CommentUpdateDeleteTest(APITestCase):
    ...
    def test_jwt_authentication(self, username="selcuk1234", password="sifre1234"):
